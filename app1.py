...
def main():
    ...
    def disp_caract(feat1,feat2):
        ...
        #fig.add_trace(go.scatter(dfnok[feat1], dfnok[feat2],  color = dfnok['TARGET'], symbol=dfnok['TARGET']))
        #plt.scatter(dfnok.feat1, dfnok.feat2, s = 10, c = 'red', marker = 'o', edgecolors = 'none')
        #plt.scatter(dfclient.feat1, dfclient.feat2, s = 40, c = 'cyan', marker = 'D', edgecolors = 'none')
        #plt.title('Représentation suivant les 2 premières caractéristique')
        #plt.savefig(fig.png)
        return fig
